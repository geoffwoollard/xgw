...
def setup_dual_polytope(vertices, A, b, implementation, use_D_sparse):
    d = vertices.shape[1]
    ...
    if implementation == 'cdd':
        ...
        dd_dual_polytope = DoubleDescription(implementation=implementation, V_initialization=dual_vertices, B_initialization=dual_B_initialization, use_D_sparse=use_D_sparse)
        ...
        dd_dual_polytope = DoubleDescription(implementation=implementation, V_initialization=dual_vertices, masks_initialization=dual_masks_initialization, A_initialization=dual_A, b_initialization=dual_b, use_D_sparse=use_D_sparse)
        dd_dual_polytope.V = dual_vertices.tolist()
        dd_dual_polytope.H = [dual_A, dual_b]
    else:
