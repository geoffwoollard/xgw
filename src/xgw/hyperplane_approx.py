...
class DoubleDescription():
    ...
    def H_to_V(self):
        ...
        def stabilize_compute_polytope_vertices(A, b, decimals_start=10, decimals_end=3):
    ...
    def V_to_H(self):
        ...
        def stabilize_compute_polytope_halfspaces(V, decimals_start=10, decimals_end=3):
